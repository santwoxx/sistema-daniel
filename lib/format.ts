...
export const ORCAMENTO_STATUS_LABEL: Record<string, string> = {
  NOVO: "Novo",
  CONTATADO: "Contatado",
  CONVERTIDO: "Convertido em montagem",
  RECUSADO: "Recusado",
};

export const ORCAMENTO_STATUS_COLOR: Record<string, string> = {
  NOVO: "bg-gold/15 text-gold-hover border border-gold/30",
  CONTATADO: "bg-blue-100 text-blue-800 border border-blue-200",
  CONVERTIDO: "bg-emerald-100 text-emerald-800 border border-emerald-200",
  RECUSADO: "bg-slate-200 text-slate-600 border border-slate-300",
};
