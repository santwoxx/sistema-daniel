...
/**
 * Lista os pedidos recebidos de sistemas externos integrados por API que
 * ainda não viraram uma montagem. Escolher "Usar esta nota" preenche o
  ...
  return (
    <Card className="border-gold/40 bg-gold/5">
      ...
      <p className="mb-3 text-sm text-slate-500">
        Pedidos enviados por um sistema externo aguardando revisão. Escolha um
        para preencher o formulário abaixo, confira os dados e clique em
        &ldquo;Salvar montagem&rdquo;.
      </p>
            ...
            <div className="flex min-w-0 items-center gap-3">
              {nota.fotoReferenciaUrl ? (
                <div className="relative h-14 w-14 shrink-0 overflow-hidden rounded-lg border border-slate-200">
                  <Image src={nota.fotoReferenciaUrl} alt="Foto do produto" fill sizes="56px" className="object-cover" />
                </div>
              ) : null}
